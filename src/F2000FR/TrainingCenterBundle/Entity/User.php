...
class User {
     ...
     * Add cv
     *
     * @param \F2000FR\TrainingCenterBundle\Entity\CV $cv
     *
     * @return User
     */
    public function addCv(\F2000FR\TrainingCenterBundle\Entity\CV $cv)
    {
        $this->cvs[] = $cv;
     ...
     * @param \F2000FR\TrainingCenterBundle\Entity\CV $cv
     */
    public function removeCv(\F2000FR\TrainingCenterBundle\Entity\CV $cv)
    {
